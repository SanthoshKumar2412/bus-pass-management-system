...
if(isset($_POST["submit"])){
    if(getimagesize($_FILES['aaphoto']['tmp_name'])==false
        && getimagesize($_FILES['aphoto']['tmp_name'])==false && getimagesize($_FILES['idcard']['tmp_name'])==false){
        ...
        $idname=$_FILES['idcard']['name'];
        $idcard=file_get_contents($idcard);
        $idcard=base64_encode($idcard);
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="doc-det">
                        ...
                        <div class="input-box">
                            ...
                            <div class="input-box">
                                <label for="idcard">id card/fees bill</label>
                                <input type="file" name="idcard" autocomplete="off" required>
                        </div>
